...
<div class="body-box" style="float:right">
	<form id="jvForm" action="tfasupdate.do?id=${tfas.id }" method="post" onsubmit="return chkAll()" >
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" id="title" class="required" name="title" maxlength="100"  value="${tfas.title}" onblur="chkTitle()" />
