...
<div class="box-positon">
	...
	<form class="ropt">
		<input type="submit" onclick="this.form.action='userupdate.do';" value="返回列表" class="return-button"/>
	</form>
	<div class="clear"></div>
</div>
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="loginname" maxlength="100"     value="${ user.loginname } "  />
					</td>
				</tr>
